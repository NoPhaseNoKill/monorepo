 ...
 */
package com.nophasenokill.docs.dsl.source
 ...
 * for later use in generating documentation for the DSL, such as by {@link com.nophasenokill.docs.dsl.docbook.AssembleDslDocTask}.
 */
@CacheableTask
abstract class ExtractDslMetaDataTask extends SourceTask {
    ...
    def extract() {
        ...
        SimpleClassMetaDataRepository<com.nophasenokill.docs.dsl.source.model.ClassMetaData> repository = new SimpleClassMetaDataRepository<com.nophasenokill.docs.dsl.source.model.ClassMetaData>()
        int counter = 0
    ...
    def parse(File sourceFile, ClassMetaDataRepository<com.nophasenokill.docs.dsl.source.model.ClassMetaData> repository) {
    ...
    def fullyQualifyAllTypeNames(com.nophasenokill.docs.dsl.source.model.ClassMetaData classMetaData, TypeNameResolver resolver) {
        try {
            ...
            classMetaData.visitTypes(new Action<com.nophasenokill.docs.dsl.source.model.TypeMetaData>() {
                void execute(com.nophasenokill.docs.dsl.source.model.TypeMetaData t) {
