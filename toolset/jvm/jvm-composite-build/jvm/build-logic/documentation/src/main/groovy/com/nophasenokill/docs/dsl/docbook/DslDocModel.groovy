...
import com.nophasenokill.docs.dsl.source.TypeNameResolver
...
class DslDocModel {
    ...
    private final Map<String, com.nophasenokill.docs.dsl.docbook.model.ClassDoc> classes = [:]
    private final ClassMetaDataRepository<ClassMetaData> classMetaData
    private final Map<String, com.nophasenokill.docs.dsl.docbook.model.ClassExtensionMetaData> extensionMetaData
    ...
    DslDocModel(File classDocbookDir, Document document, ClassMetaDataRepository<ClassMetaData> classMetaData, Map<String, com.nophasenokill.docs.dsl.docbook.model.ClassExtensionMetaData> extensionMetaData) {
    ...
    Collection<com.nophasenokill.docs.dsl.docbook.model.ClassDoc> getClasses() {
    ...
    com.nophasenokill.docs.dsl.docbook.model.ClassDoc findClassDoc(String className) {
        com.nophasenokill.docs.dsl.docbook.model.ClassDoc classDoc = classes[className]
    ...
    com.nophasenokill.docs.dsl.docbook.model.ClassDoc getClassDoc(String className) {
        com.nophasenokill.docs.dsl.docbook.model.ClassDoc classDoc = classes[className]
        if (classDoc == null) {
    ...
    private com.nophasenokill.docs.dsl.docbook.model.ClassDoc loadClassDoc(String className) {
        ...
        try {
            ...
            try {
                com.nophasenokill.docs.dsl.docbook.model.ClassExtensionMetaData extensionMetaData = extensionMetaData[className]
                if (!extensionMetaData) {
                    extensionMetaData = new com.nophasenokill.docs.dsl.docbook.model.ClassExtensionMetaData(className)
                }
                ...
                def doc = new com.nophasenokill.docs.dsl.docbook.model.ClassDoc(className, provider.parse(classFile), document, classMetaData, extensionMetaData)
