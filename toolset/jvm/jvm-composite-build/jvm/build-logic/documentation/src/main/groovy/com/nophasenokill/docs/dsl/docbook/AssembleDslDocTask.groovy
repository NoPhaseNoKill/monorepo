...
import com.nophasenokill.docs.BuildableDOMCategory
import com.nophasenokill.docs.DocGenerationException
import com.nophasenokill.docs.XIncludeAwareXmlProvider
import com.nophasenokill.docs.dsl.links.ClassLinkMetaData
import com.nophasenokill.docs.dsl.links.LinkMetaData
import com.nophasenokill.docs.dsl.source.model.ClassMetaData
import com.nophasenokill.docs.model.ClassMetaDataRepository
import com.nophasenokill.docs.model.SimpleClassMetaDataRepository
 ...
 * <ul>
 * <li>Meta-data extracted from the source by {@link com.nophasenokill.docs.dsl.source.ExtractDslMetaDataTask}.</li>
...
abstract class AssembleDslDocTask extends DefaultTask {
    ...
    @CompileStatic
    DslDocModel createDslDocModel(File classDocbookDir, Document document, ClassMetaDataRepository<ClassMetaData> classMetaData, Map<String, com.nophasenokill.docs.dsl.docbook.model.ClassExtensionMetaData> extensionMetaData) {
    ...
    def loadPluginsMetaData() {
        ...
        Map<String, com.nophasenokill.docs.dsl.docbook.model.ClassExtensionMetaData> extensions = [:]
        provider.root.plugin.each { Element plugin ->
            ...
            plugin.extends.each { Element e ->
                ...
                if (!extension) {
                    extension = new com.nophasenokill.docs.dsl.docbook.model.ClassExtensionMetaData(targetClass)
    ...
    def mergeBlock(Element tr, com.nophasenokill.docs.dsl.docbook.model.ClassDoc project) {
        String blockName = tr.td[0].text().trim()
        com.nophasenokill.docs.dsl.docbook.model.BlockDoc blockDoc = project.getBlock(blockName)
        tr.children = {
    ...
    def mergeType(Element typeTr, DslDocModel model) {
        ...
        com.nophasenokill.docs.dsl.docbook.model.ClassDoc classDoc = model.getClassDoc(className)
        typeTr.children = {
            td {
    ...
    def generateDocForType(Document document, DslDocModel model, ClassMetaDataRepository<ClassLinkMetaData> linkRepository, com.nophasenokill.docs.dsl.docbook.model.ClassDoc classDoc) {
        try {
