import com.nophasenokill.basics.classanalysis.Attributes.artifactType
import com.nophasenokill.basics.classanalysis.Attributes.minified
import com.nophasenokill.basics.transforms.Minify
