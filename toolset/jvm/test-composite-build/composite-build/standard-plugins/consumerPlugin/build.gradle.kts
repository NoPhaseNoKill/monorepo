...
buildscript {
    dependencies.classpath("com.nophasenokill", "producerPlugin", "1.0.0-local-dev", "default") {
...
gradle.taskGraph.whenReady {
    if(!pluginManager.hasPlugin("com.nophasenokill.producer")) {
        pluginManager.apply("com.nophasenokill.producer")
    }
}
...
dependencies {
    /*
        ...
        implementation(project(":producerPlugin"))
            OR
        implementation(project("com.nophasenokill:producerPlugin", configuration = "default"))
            OR
        implementation(DefaultExternalModuleDependency("com.nophasenokill", "producerPlugin", "1.0.0-local-dev", "default"))
            OR
        project.dependencies.add(
            "implementation",
            project.dependencies.project(mapOf("path" to rootProject.relativePath(":meta-plugins:producerPlugin"), "configuration" to "default"))
        )
