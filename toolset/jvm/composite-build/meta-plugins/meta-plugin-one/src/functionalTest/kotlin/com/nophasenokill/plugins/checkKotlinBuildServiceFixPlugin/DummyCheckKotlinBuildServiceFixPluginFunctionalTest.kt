...
class DummyCheckKotlinBuildServiceFixPluginFunctionalTest: IntegrationTest() {
    ...
    @Test
    fun `should fine build service warning without plugin, and should not receive build service warning when plugin is applied`(context: ExtensionContext) = runTestScope {
