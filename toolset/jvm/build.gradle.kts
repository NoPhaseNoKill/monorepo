...
tasks.register("buildAllComposite") {
    dependsOn(gradle.includedBuild("meta-plugins").task(":build"))
    dependsOn(gradle.includedBuild("platforms").task(":build"))
    dependsOn(gradle.includedBuild("libraries").task(":build"))
    dependsOn(gradle.includedBuild("applications").task(":build"))
    dependsOn(gradle.includedBuild("standalone-plugins").task(":build"))
}
