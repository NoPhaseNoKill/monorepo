...
class KotlinDesktopApplicationPlugin: Plugin<Project> {
    override fun apply(project: Project) {
        ...
        project.run {
            ...
            if(!project.pluginManager.hasPlugin("com.nophasenokill.repositories-plugin")) {
                project.pluginManager.apply("com.nophasenokill.repositories-plugin")
            }
            ...
            dependencies {
                ...
                add("implementation", versionCatalog.findCatalogLibrary("gradleToolingApi"))
