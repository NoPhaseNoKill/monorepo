...
object EnableAndroidLintMutation :
    ...
    override val id: String = "com.nophasenokill.client.demo.mutations.lintEnable.android"
}

object SetVersionCodeMutation : AndroidPrototypeMutationDefinition {
    override val id: String = "com.nophasenokill.client.demo.mutations.versionCode"
...
object SetNamespaceMutation : AndroidPrototypeMutationDefinition {
    override val id: String = "com.nophasenokill.client.demo.mutations.namespace"
...
val addTestingDependencyMutation = run {
    val addDependency = AddDependencyMutation(
        "com.nophasenokill.client.demo.mutations.addDependency.testing",
        { hasAndroidPrototype() },
        {
...
val addLibraryDependencyMutation =
    AddDependencyMutation(
        "com.nophasenokill.client.demo.mutations.addDependency.topLevel.library",
        { hasAndroidPrototype() },
...
val addApplicationDependencyMutation =
    AddDependencyMutation(
        "com.nophasenokill.client.demo.mutations.addDependency.topLevel.application",
        { hasAndroidPrototype() },
