package com.nophasenokill.client.ui.build
...
import com.nophasenokill.client.core.gradle.GradleConnectionParameters.Companion.isValidGradleInstallation
import com.nophasenokill.client.core.gradle.GradleConnectionParameters.Companion.isValidGradleUserHome
import com.nophasenokill.client.core.gradle.GradleConnectionParameters.Companion.isValidGradleVersion
import com.nophasenokill.client.core.gradle.GradleConnectionParameters.Companion.isValidJavaHome
...
private fun BuildMainContent(component: BuildComponent, build: Build, snackbarState: SnackbarHostState) {
    ...
    Column(
        ...
        DirectoryField(
            ...
            state = javaHome,
            defaultState = System.getProperty("java.home").takeIf { it.isNotBlank() },
