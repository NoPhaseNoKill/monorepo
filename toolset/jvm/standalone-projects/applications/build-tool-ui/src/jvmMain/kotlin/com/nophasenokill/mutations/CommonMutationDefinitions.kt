...
val addCommonLibraryDependencyMutation =
    AddDependencyMutation(
        "com.nophasenokill.client.demo.mutations.addDependency.toLibrary",
...
val addCommonApplicationDependencyMutation =
    AddDependencyMutation(
        "com.nophasenokill.client.demo.mutations.addDependency.toApplication",
        { hasCommonDependencies() },
...
val addTestingDependencyMutations: List<MutationDefinition> = run {
    fun mutationForOwner(
        ...
        val addDependency = AddDependencyMutation(
            "com.nophasenokill.client.demo.mutations.addDependency.toTesting.$idSuffix",
            { isCompatible() },
