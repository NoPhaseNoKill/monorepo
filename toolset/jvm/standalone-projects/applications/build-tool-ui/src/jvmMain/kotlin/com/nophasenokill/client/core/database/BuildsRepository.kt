...
import com.nophasenokill.client.core.database.sqldelight.generated.queries.BuildsQueries
    ...
    object DbBuildMapper : (String, String, String?, String?, String?) -> Build {
        override fun invoke(
            ...
            gradleDistribution = gradleDistributionJson
                ...
                ?: com.nophasenokill.client.core.gradle.GradleDistribution.Default,
        )
    }
}
