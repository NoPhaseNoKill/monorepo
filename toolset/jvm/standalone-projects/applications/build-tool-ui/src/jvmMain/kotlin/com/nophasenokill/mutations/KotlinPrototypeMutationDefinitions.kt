package com.nophasenokill.mutations
...
object EnableKotlinLintMutation :
    ...
    override val id: String = "com.nophasenokill.client.demo.mutations.lintEnable.kotlinJvm"
}
...
class AddKotlinTargetMutation(
    ...
    override val id: String = "com.nophasenokill.client.demo.mutations.kotlin.$owner.target.add.$targetName"
...
val kmpAddDependencyMutations = kotlinSoftwareInfos.flatMap { softwareType ->
    softwareType.targets.map { target ->
        AddDependencyMutation(
            "com.nophasenokill.client.demo.mutations.addDependency.kmp.${softwareType.kindName}.${target.name}",
            { hasKotlinPrototype() },
            {
                with(softwareType) {
                    with(target) {
...
object SetKmpJvmApplicationMainClass : KotlinPrototypeMutationDefinition {
    override val id: String = "com.nophasenokill.client.demo.mutations.kmpJvm.application.setMainClass"
...
object SetKmpJvmApplicationJdkVersion : KotlinPrototypeMutationDefinition {
    override val id: String = "com.nophasenokill.client.demo.mutations.kmpJvm.application.setJdkVersion"
...
object SetKmpJvmLibraryJdkVersion : KotlinPrototypeMutationDefinition {
    override val id: String = "com.nophasenokill.client.demo.mutations.kmpJvm.library.setJdkVersion"
    override val name: String = "Set JDK version"
    override val description: String = "Set the JDK version for target"
...
object SetKmpNativeApplicationEntryPoint : KotlinPrototypeMutationDefinition {
    override val id: String = "com.nophasenokill.client.demo.mutations.kmpNative.application.setEntryPoint"
